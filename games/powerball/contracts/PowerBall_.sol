...
contract PowerBall is owned {
    ...
    function PowerBall(address addressRng) { // Constructor
        ...
        arCasinoWhiteBalls = new uint16[](0);
	    ...
	    // betValueIsOk 
	{
		...
		// arCasinoWhiteBalls = wb;
		arCasinoWhiteBalls = [1,2,3,4,5];
