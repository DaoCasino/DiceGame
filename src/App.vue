<template lang="pug">
  #app
    .game__buttons(v-bind:class="{ none: chat }")
      a.game__but.game__but-rules(href="#" @click.prevent="updateTrigger" data-name="rules")
      ...
      a.game__but.game__but-chat(href="#" @click.prevent="updateTrigger" data-name="chat")
        svg.game__but-svg(xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512")
